...
import { topLinks } from "../user-sidebar/sidebar.properties";
      ...
      <div className="flex items-center justify-start py-1.5 px-4 gap-x-3">
        ...
        <div className="min-w-44">
          <p className="text-sm text-gray-400">
            Hello, <strong className="text-blue-500">{name}</strong>
          </p>
          <p className="text-sm text-gray-400">
            UID:{" "}
            <strong className="text-blue-500">{session?.user.accountId}</strong>
          </p>
        </div>
      </div>
